...
if __name__ == "__main__":
    ...
    fitter = Fitter(dir_name, remove_output=True)#True) 
    ...
    allnames = []
    mocknames = ['desi_kp4_abacus_cubicbox_pk_c000_gridc003_elg.pkl']#, 'desi_kp4_abacus_cubicbox_cv']
    for i, mockname in enumerate(mocknames):
        ...
        for recon in [None, "sym"]:
            ...
            dataset_pk = PowerSpectrum_DESI_KP4(
                ...
                num_mocks=25,            # Used for Hartlap/Sellentin correction if correction=Correction.HARTLAP or Correction.SELLENTIN
...
#             #    model.set_default("sigma_s", 15, min=0.0, max=25.0, sigma=4.0, prior="gaussian")
